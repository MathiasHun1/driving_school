...
@Component({
  standalone: true,
  selector: 'app-category-a1b',
  imports: [CommonModule],
  templateUrl: './category-a1b.component.html',
  styleUrl: './category-a1b.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CategoryA1bComponent {
  readonly title = '"A1" kategória "B"-vel';
  ...
  readonly noteTitle = 'Kezdő vezetői engedély ("A1" "B"-vel)';
  ...
  readonly admission = [
    'meglévő "B" kategóriás jogosítvány ;',
